...
MIGRATION_MODULES = {"sites": "authenbite.contrib.sites.migrations"}
...
ACCOUNT_FORMS = {"signup": "authenbite.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "authenbite.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "authenbite.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "authenbite API",
    "DESCRIPTION": "Documentation of API endpoints of authenbite",
    "VERSION": "1.0.0",
